...
Supporting detail for the technical report in [`../README.md`](../README.md). The report
itself is kept to the 3–5 pages the assignment specifies; this appendix holds the full
narrative behind each design decision, the complete defect log, and the extended
model-scale comparison, for a reader who wants the workings rather than the conclusions.

Section numbers here match the summary points in the report.
